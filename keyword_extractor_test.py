...
class KeywordExtractorTest(unittest.TestCase):
    ...
    def test_strip_email_url(self):
        ...
        """
        self.assertEqual(KeywordExtractor(os.path.join(self.script_folder, "test"), "21717-de.txt", os.path.abspath(os.path.join(self.output_folder, "test-out")))._strip_email_url("ecco la mia email io-ho_33Anni@poste.paese e il mio sito:http://www.sito.kria"), 'ecco la mia email  e il mio sito:')
    ...
    def test_de_proper_nouns_fill_main_lang_dictionaries_with_tree_tagger(self):
        ...
        """
        kw_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "small-mixed.txt", os.path.abspath(os.path.join(self.output_folder, "test-out")))
    ...
    def test_it_fill_dictionaries_with_treetagger(self):
        ...
        """
        kw_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "small-mixed2.txt", os.path.abspath(os.path.join(self.output_folder, "test-out")))
    ...
    def test_it_extract_keywords(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "1008-it.txt", os.path.abspath(os.path.join(self.output_folder, "out-test")))
    ...
    def test_it_extract_keywords_2(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "1014-it.txt", os.path.abspath(os.path.join(self.output_folder, "out-test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_4(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "1028.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_5(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10006.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_8(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10046.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_9(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10053.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_10(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10152.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_11(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10157.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_13(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10187.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_15(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10212.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_16(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10225.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_17(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10227.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_19(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10267.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_20(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10275.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_21(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10286.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_22(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10288.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_23(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10290.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_24(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10293.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_it_extract_keywords_25(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10297.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
        self.assertEqual(key_words_set, {'colposo','Federico Aldrovandi'})

    def test_it_extract_keywords_28(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "10328.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_30(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21870.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_31_2(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21891.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_32(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21905.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_35(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21921.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_40(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21965.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_41(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21969.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_43(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21984.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_44(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21986.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_47(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "22003.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_48(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "22008.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_50(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "22024.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_52(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "22051.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_53(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "22056.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
    ...
    def test_de_extract_keywords_55(self):
        key_word_extractor = KeywordExtractor(os.path.join(self.script_folder,"test"), "21717-de.txt", os.path.abspath(os.path.join(self.output_folder, "test")))
        key_words_set = key_word_extractor.extract_keywords()
